 ...
 * of this value object you may modify the generated sub-class of this class - DlvdYTDResults.as.
 */
...
import valueObjects.DlvdYTDData;
...
[ExcludeClass]
public class _Super_DlvdYTDResults extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    {
        valueObjects.DlvdYTDData.initRemoteClassAliasSingleChild();
    ...
    model_internal var _dminternal_model : _DlvdYTDResultsEntityMetadata;
    ...
    model_internal var _internal_data_leaf:valueObjects.DlvdYTDData;
    private var _internal_metaData : ArrayCollection;
    model_internal var _internal_metaData_leaf:valueObjects.MetaData;
    ...
    public function _Super_DlvdYTDResults()
    {
        _model = new _DlvdYTDResultsEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _DlvdYTDResultsEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _DlvdYTDResultsEntityMetadata) : void
    {
        var oldValue : _DlvdYTDResultsEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
