 ...
 * of this value object you may modify the generated sub-class of this class - APIKeyResults.as.
 */
...
[ExcludeClass]
public class _Super_APIKeyResults extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    {
        valueObjects.APIKeyData.initRemoteClassAliasSingleChild();
    }

    model_internal var _dminternal_model : _APIKeyResultsEntityMetadata;
    ...
    model_internal var _internal_data_leaf:valueObjects.APIKeyData;
    ...
    public function _Super_APIKeyResults()
    {
        _model = new _APIKeyResultsEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _APIKeyResultsEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _APIKeyResultsEntityMetadata) : void
    {
        var oldValue : _APIKeyResultsEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
