 ...
 * of this value object you may modify the generated sub-class of this class - CalendarDayResults.as.
 */
...
[ExcludeClass]
public class _Super_CalendarDayResults extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    {
        valueObjects.CalendarDayData.initRemoteClassAliasSingleChild();
    ...
    model_internal var _dminternal_model : _CalendarDayResultsEntityMetadata;
    ...
    model_internal var _internal_data_leaf:valueObjects.CalendarDayData;
    ...
    public function _Super_CalendarDayResults()
    {
        _model = new _CalendarDayResultsEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _CalendarDayResultsEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _CalendarDayResultsEntityMetadata) : void
    {
        var oldValue : _CalendarDayResultsEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
