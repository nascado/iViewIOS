 ...
 * of this value object you may modify the generated sub-class of this class - EquipmentUtilizationFCLData.as.
 */
...
[ExcludeClass]
public class _Super_EquipmentUtilizationFCLData extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    model_internal var _dminternal_model : _EquipmentUtilizationFCLDataEntityMetadata;
     ...
     * properties
     */
    private var _internal_Fact1 : Number = Number(0);
    private var _internal_Fact2 : Object;
    ...
    public function _Super_EquipmentUtilizationFCLData()
    {
        _model = new _EquipmentUtilizationFCLDataEntityMetadata(this);
    ...
    public function get Fact1() : Number
    {
        return _internal_Fact1;
    }

    [Bindable(event="propertyChange")]
    public function get Fact2() : Object
    {
    ...
    public function set Fact1(value:Number) : void
    {
        var oldValue:Number = _internal_Fact1;
        if (isNaN(_internal_Fact1) == true || Math.abs(oldValue - value) > epsilon)
        {
    ...
    public function set Fact2(value:Object) : void
    {
        var oldValue:Object = _internal_Fact2;
        if (oldValue !== value)
        {
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _EquipmentUtilizationFCLDataEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _EquipmentUtilizationFCLDataEntityMetadata) : void
    {
        var oldValue : _EquipmentUtilizationFCLDataEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
    ...
    model_internal var _doValidationLastValOfFact2 : Object;
