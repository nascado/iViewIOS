 ...
 * of this value object you may modify the generated sub-class of this class - POItemResults.as.
 */
...
[ExcludeClass]
public class _Super_POItemResults extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    {
        valueObjects.POItemData.initRemoteClassAliasSingleChild();
    }

    model_internal var _dminternal_model : _POItemResultsEntityMetadata;
    ...
    model_internal var _internal_data_leaf:valueObjects.POItemData;
    ...
    public function _Super_POItemResults()
    {
        _model = new _POItemResultsEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _POItemResultsEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _POItemResultsEntityMetadata) : void
    {
        var oldValue : _POItemResultsEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
