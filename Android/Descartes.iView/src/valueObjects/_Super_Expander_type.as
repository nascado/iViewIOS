 ...
 * of this value object you may modify the generated sub-class of this class - Expander_type.as.
 */
...
[ExcludeClass]
public class _Super_Expander_type extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    model_internal var _dminternal_model : _Expander_typeEntityMetadata;
    ...
    private var _internal_PO_SODate : String;
    private var _internal_PartSONumber : String;
    private var _internal_Quantity : int;
    private var _internal_PO_SONumber : String;
    private var _internal_PO_HeaderId : String;
    private var _internal_RowSONumber : int;
    private var _internal_UOM : String;
    private var _internal_PartDescription : String;
    private var _internal_Items : ArrayCollection;
    model_internal var _internal_Items_leaf:valueObjects.Items_type;
    ...
    public function _Super_Expander_type()
    {
        _model = new _Expander_typeEntityMetadata(this);

        // Bind to own data or source properties for cache invalidation triggering
        model_internal::_changeWatcherArray.push(mx.binding.utils.ChangeWatcher.watch(this, "PO_SODate", model_internal::setterListenerPO_SODate));
        model_internal::_changeWatcherArray.push(mx.binding.utils.ChangeWatcher.watch(this, "PartSONumber", model_internal::setterListenerPartSONumber));
        model_internal::_changeWatcherArray.push(mx.binding.utils.ChangeWatcher.watch(this, "PO_SONumber", model_internal::setterListenerPO_SONumber));
    ...
    [Bindable(event="propertyChange")]
    public function get PO_SODate() : String
    {
        return _internal_PO_SODate;
    }

    [Bindable(event="propertyChange")]
    public function get PartSONumber() : String
    {
        return _internal_PartSONumber;
    }
    ...
    [Bindable(event="propertyChange")]
    public function get PO_SONumber() : String
    {
        return _internal_PO_SONumber;
    }
    ...
    [Bindable(event="propertyChange")]
    public function get RowSONumber() : int
    {
        return _internal_RowSONumber;
    }
    ...
    public function set PO_SODate(value:String) : void
    {
        var oldValue:String = _internal_PO_SODate;
        if (oldValue !== value)
        {
            _internal_PO_SODate = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "PO_SODate", oldValue, _internal_PO_SODate));
        }
    }

    public function set PartSONumber(value:String) : void
    {
        var oldValue:String = _internal_PartSONumber;
        if (oldValue !== value)
        {
            _internal_PartSONumber = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "PartSONumber", oldValue, _internal_PartSONumber));
        }
    }
    ...
    public function set PO_SONumber(value:String) : void
    {
        var oldValue:String = _internal_PO_SONumber;
        if (oldValue !== value)
        {
            _internal_PO_SONumber = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "PO_SONumber", oldValue, _internal_PO_SONumber));
        }
    }
    ...
    public function set RowSONumber(value:int) : void
    {
        var oldValue:int = _internal_RowSONumber;
        if (oldValue !== value)
        {
            _internal_RowSONumber = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "RowSONumber", oldValue, _internal_RowSONumber));
        }
    }
    ...
    model_internal function setterListenerPO_SODate(value:flash.events.Event):void
    {
        _model.invalidateDependentOnPO_SODate();
    }

    model_internal function setterListenerPartSONumber(value:flash.events.Event):void
    {
        _model.invalidateDependentOnPartSONumber();
    }

    model_internal function setterListenerPO_SONumber(value:flash.events.Event):void
    {
        _model.invalidateDependentOnPO_SONumber();
    }
    ...
    model_internal function calculateIsValid():Boolean
    {
        ...
        if (!_model.PO_SODateIsValid)
        {
            propertyValidity = false;
            com.adobe.fiber.util.FiberUtils.arrayAdd(validationFailureMessages, _model.model_internal::_PO_SODateValidationFailureMessages);
        }
        if (!_model.PartSONumberIsValid)
        {
            propertyValidity = false;
            com.adobe.fiber.util.FiberUtils.arrayAdd(validationFailureMessages, _model.model_internal::_PartSONumberValidationFailureMessages);
        }
        if (!_model.PO_SONumberIsValid)
        {
            propertyValidity = false;
            com.adobe.fiber.util.FiberUtils.arrayAdd(validationFailureMessages, _model.model_internal::_PO_SONumberValidationFailureMessages);
        }
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _Expander_typeEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _Expander_typeEntityMetadata) : void
    {
        var oldValue : _Expander_typeEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
    ...
    model_internal var _doValidationCacheOfPO_SODate : Array = null;
    model_internal var _doValidationLastValOfPO_SODate : String;

    model_internal function _doValidationForPO_SODate(valueIn:Object):Array
    {
        var value : String = valueIn as String;

        if (model_internal::_doValidationCacheOfPO_SODate != null && model_internal::_doValidationLastValOfPO_SODate == value)
           return model_internal::_doValidationCacheOfPO_SODate ;

        _model.model_internal::_PO_SODateIsValidCacheInitialized = true;
        var validationFailures:Array = new Array();
        var errorMessage:String;
        var failure:Boolean;

        var valRes:ValidationResult;
        if (_model.isPO_SODateAvailable && _internal_PO_SODate == null)
        {
            validationFailures.push(new ValidationResult(true, "", "", "PO_SODate is required"));
        }

        model_internal::_doValidationCacheOfPO_SODate = validationFailures;
        model_internal::_doValidationLastValOfPO_SODate = value;

        return validationFailures;
    }
    
    model_internal var _doValidationCacheOfPartSONumber : Array = null;
    model_internal var _doValidationLastValOfPartSONumber : String;

    model_internal function _doValidationForPartSONumber(valueIn:Object):Array
    {
        var value : String = valueIn as String;

        if (model_internal::_doValidationCacheOfPartSONumber != null && model_internal::_doValidationLastValOfPartSONumber == value)
           return model_internal::_doValidationCacheOfPartSONumber ;

        _model.model_internal::_PartSONumberIsValidCacheInitialized = true;
        var validationFailures:Array = new Array();
        var errorMessage:String;
        var failure:Boolean;

        var valRes:ValidationResult;
        if (_model.isPartSONumberAvailable && _internal_PartSONumber == null)
        {
            validationFailures.push(new ValidationResult(true, "", "", "PartSONumber is required"));
        }

        model_internal::_doValidationCacheOfPartSONumber = validationFailures;
        model_internal::_doValidationLastValOfPartSONumber = value;

        return validationFailures;
    }
    
    model_internal var _doValidationCacheOfPO_SONumber : Array = null;
    model_internal var _doValidationLastValOfPO_SONumber : String;

    model_internal function _doValidationForPO_SONumber(valueIn:Object):Array
    {
        var value : String = valueIn as String;

        if (model_internal::_doValidationCacheOfPO_SONumber != null && model_internal::_doValidationLastValOfPO_SONumber == value)
           return model_internal::_doValidationCacheOfPO_SONumber ;

        _model.model_internal::_PO_SONumberIsValidCacheInitialized = true;
        var validationFailures:Array = new Array();
        var errorMessage:String;
        var failure:Boolean;

        var valRes:ValidationResult;
        if (_model.isPO_SONumberAvailable && _internal_PO_SONumber == null)
        {
            validationFailures.push(new ValidationResult(true, "", "", "PO_SONumber is required"));
        }

        model_internal::_doValidationCacheOfPO_SONumber = validationFailures;
        model_internal::_doValidationLastValOfPO_SONumber = value;
