 ...
 * of this value object you may modify the generated sub-class of this class - SOPurchaseOrderResults.as.
 */
...
[ExcludeClass]
public class _Super_SOPurchaseOrderResults extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    {
        valueObjects.SOPurchaseOrderData.initRemoteClassAliasSingleChild();
    }

    model_internal var _dminternal_model : _SOPurchaseOrderResultsEntityMetadata;
    ...
    model_internal var _internal_data_leaf:valueObjects.SOPurchaseOrderData;
    ...
    public function _Super_SOPurchaseOrderResults()
    {
        _model = new _SOPurchaseOrderResultsEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _SOPurchaseOrderResultsEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _SOPurchaseOrderResultsEntityMetadata) : void
    {
        var oldValue : _SOPurchaseOrderResultsEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
