 ...
 * of this value object you may modify the generated sub-class of this class - ChartCalendarSummaryResults.as.
 */
...
[ExcludeClass]
public class _Super_ChartCalendarSummaryResults extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    {
        valueObjects.ChartCalendarSummaryData.initRemoteClassAliasSingleChild();
    }

    model_internal var _dminternal_model : _ChartCalendarSummaryResultsEntityMetadata;
    ...
    model_internal var _internal_data_leaf:valueObjects.ChartCalendarSummaryData;
    ...
    public function _Super_ChartCalendarSummaryResults()
    {
        _model = new _ChartCalendarSummaryResultsEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _ChartCalendarSummaryResultsEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _ChartCalendarSummaryResultsEntityMetadata) : void
    {
        var oldValue : _ChartCalendarSummaryResultsEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
