 ...
 * of this value object you may modify the generated sub-class of this class - SummaryResults.as.
 */
...
[ExcludeClass]
public class _Super_SummaryResults extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    {
        valueObjects.SummaryResultsData.initRemoteClassAliasSingleChild();
    }

    model_internal var _dminternal_model : _SummaryResultsEntityMetadata;
    ...
    model_internal var _internal_data_leaf:valueObjects.SummaryResultsData;
    ...
    public function _Super_SummaryResults()
    {
        _model = new _SummaryResultsEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _SummaryResultsEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _SummaryResultsEntityMetadata) : void
    {
        var oldValue : _SummaryResultsEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
