 ...
 * of this value object you may modify the generated sub-class of this class - ShipmentPartiesResult.as.
 */
...
[ExcludeClass]
public class _Super_ShipmentPartiesResult extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    {
        valueObjects.ShipmentPartiesData.initRemoteClassAliasSingleChild();
    }

    model_internal var _dminternal_model : _ShipmentPartiesResultEntityMetadata;
    ...
    model_internal var _internal_data_leaf:valueObjects.ShipmentPartiesData;
    private var _internal_records : int;
    ...
    public function _Super_ShipmentPartiesResult()
    {
        _model = new _ShipmentPartiesResultEntityMetadata(this);
    ...
    [Bindable(event="propertyChange")]
    public function get records() : int
    {
    ...
    public function set records(value:int) : void
    {
        var oldValue:int = _internal_records;
        if (oldValue !== value)
        {
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _ShipmentPartiesResultEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _ShipmentPartiesResultEntityMetadata) : void
    {
        var oldValue : _ShipmentPartiesResultEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
