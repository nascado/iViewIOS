 ...
 * of this value object you may modify the generated sub-class of this class - POMetaData.as.
 */
...
[ExcludeClass]
public class _Super_POMetaData extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    model_internal var _dminternal_model : _POMetaDataEntityMetadata;
    ...
    model_internal var _internal_sortInfo_leaf:valueObjects.POSortInfo;
    private var _internal_fields : ArrayCollection;
    model_internal var _internal_fields_leaf:valueObjects.POFields;
    ...
    public function _Super_POMetaData()
    {
        _model = new _POMetaDataEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _POMetaDataEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _POMetaDataEntityMetadata) : void
    {
        var oldValue : _POMetaDataEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
