...
[ExcludeClass]
internal class _ContainerResultDataEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    private static var emptyArray:Array = new Array();

    model_internal static var allProperties:Array = new Array("Packages", "ContainerNumber", "CBM", "Lbs", "SizeType", "Comment", "ShipmentId", "Pieces", "Seal2", "InputNumber", "Seal", "CFT", "FileId", "Seal3", "Kgs", "Status", "ContainerId");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("Packages", "ContainerNumber", "CBM", "Lbs", "SizeType", "Comment", "ShipmentId", "Pieces", "Seal2", "InputNumber", "Seal", "CFT", "FileId", "Seal3", "Kgs", "Status", "ContainerId");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("Packages", "ContainerNumber", "CBM", "Lbs", "SizeType", "Comment", "ShipmentId", "Pieces", "Seal2", "InputNumber", "Seal", "CFT", "FileId", "Seal3", "Kgs", "Status", "ContainerId");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("Packages", "ContainerNumber", "CBM", "Lbs", "SizeType", "Comment", "ShipmentId", "Pieces", "Seal2", "InputNumber", "Seal", "CFT", "FileId", "Seal3", "Kgs", "Status", "ContainerId");
    model_internal static var sourceProperties:Array = emptyArray
    model_internal static var nonDerivedProperties:Array = new Array("Packages", "ContainerNumber", "CBM", "Lbs", "SizeType", "Comment", "ShipmentId", "Pieces", "Seal2", "InputNumber", "Seal", "CFT", "FileId", "Seal3", "Kgs", "Status", "ContainerId");
    model_internal static var derivedProperties:Array = new Array();
    model_internal static var collectionProperties:Array = new Array();
    model_internal static var collectionBaseMap:Object;
    model_internal static var entityName:String = "ContainerResultData";
    ...
    model_internal var _InputNumberIsValid:Boolean;
    model_internal var _InputNumberValidator:com.adobe.fiber.styles.StyleValidator;
    model_internal var _InputNumberIsValidCacheInitialized:Boolean = false;
    model_internal var _InputNumberValidationFailureMessages:Array;
    ...
    model_internal var _instance:_Super_ContainerResultData;
    model_internal static var _nullStyle:com.adobe.fiber.styles.Style = new com.adobe.fiber.styles.Style();

    public function _ContainerResultDataEntityMetadata(value : _Super_ContainerResultData)
    {
        ...
        model_internal::propertyTypeMap["InputNumber"] = "String";
        ...
        model_internal::_InputNumberValidator = new StyleValidator(model_internal::_instance.model_internal::_doValidationForInputNumber);
        model_internal::_InputNumberValidator.required = true;
        model_internal::_InputNumberValidator.requiredFieldError = "InputNumber is required";
        //model_internal::_InputNumberValidator.source = model_internal::_instance;
        //model_internal::_InputNumberValidator.property = "InputNumber";
    ...
    override public function getDependants(propertyName:String):Array
    {
       if (model_internal::nonDerivedProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a data property of entity ContainerResultData");
    ...
    override public function getCollectionBase(propertyName:String):String
    {
        if (model_internal::collectionProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a collection property of entity ContainerResultData");
    ...
    override public function getPropertyType(propertyName:String):String
    {
        if (model_internal::allProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a property of ContainerResultData");
    ...
    override public function getValue(propertyName:String):*
    {
        if (model_internal::allProperties.indexOf(propertyName) == -1)
        {
            throw new Error(propertyName + " does not exist for entity ContainerResultData");
        }
    ...
    override public function setValue(propertyName:String, value:*):void
    {
        if (model_internal::nonDerivedProperties.indexOf(propertyName) == -1)
        {
            throw new Error(propertyName + " is not a modifiable property of entity ContainerResultData");
        }
    ...
    public function invalidateDependentOnInputNumber():void
    {
        if (model_internal::_InputNumberIsValidCacheInitialized )
        {
            model_internal::_instance.model_internal::_doValidationCacheOfInputNumber = null;
            model_internal::calculateInputNumberIsValid();
        }
    }
    ...
    public function get InputNumberValidator() : StyleValidator
    {
        return model_internal::_InputNumberValidator;
    }

    model_internal function set _InputNumberIsValid_der(value:Boolean):void 
    {
        var oldValue:Boolean = model_internal::_InputNumberIsValid;         
        if (oldValue !== value)
        {
            model_internal::_InputNumberIsValid = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "InputNumberIsValid", oldValue, value));
        }                             
    }

    [Bindable(event="propertyChange")]
    public function get InputNumberIsValid():Boolean
    {
        if (!model_internal::_InputNumberIsValidCacheInitialized)
        {
            model_internal::calculateInputNumberIsValid();
        ...
        return model_internal::_InputNumberIsValid;
    }

    model_internal function calculateInputNumberIsValid():void
    {
        var valRes:ValidationResultEvent = model_internal::_InputNumberValidator.validate(model_internal::_instance.InputNumber)
        model_internal::_InputNumberIsValid_der = (valRes.results == null);
        model_internal::_InputNumberIsValidCacheInitialized = true;
        if (valRes.results == null)
             model_internal::InputNumberValidationFailureMessages_der = emptyArray;
        else
        {
            var _valFailures:Array = new Array();
            for (var a:int = 0 ; a<valRes.results.length ; a++)
            ...
            model_internal::InputNumberValidationFailureMessages_der = _valFailures;
        }
    }

    [Bindable(event="propertyChange")]
    public function get InputNumberValidationFailureMessages():Array
    {
        if (model_internal::_InputNumberValidationFailureMessages == null)
            model_internal::calculateInputNumberIsValid();

        return _InputNumberValidationFailureMessages;
    }

    model_internal function set InputNumberValidationFailureMessages_der(value:Array) : void
    {
        var oldValue:Array = model_internal::_InputNumberValidationFailureMessages;
        ...
        if (needUpdate)
        {
            model_internal::_InputNumberValidationFailureMessages = value;   
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "InputNumberValidationFailureMessages", oldValue, value));
            // Only execute calculateIsValid if it has been called before, to update the validationFailureMessages for
            // the entire entity.
            if (model_internal::_instance.model_internal::_cacheInitialized_isValid)
            {
     ...
     */  
     override public function getPropertyValidationFailureMessages(propertyName:String):Array
     {
         switch(propertyName)
         {
            ...
            case("InputNumber"):
            {
                return InputNumberValidationFailureMessages;
            }
            case("Seal"):
            {
