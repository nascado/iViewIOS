...
[ExcludeClass]
internal class _ShipmentResultDataEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    private static var emptyArray:Array = new Array();

    model_internal static var allProperties:Array = new Array("StatusCode", "RequestedDeliveryDateTime", "ContactFax", "ConfirmedArrivalDate", "FileNumber", "Commodity", "ThirdParty", "No40HC", "PlaceOfReceipt", "ServiceType", "ShipmentId", "LCLFlag", "Pieces", "CFT", "ClearedDateTime", "Module", "ReeferTemperature", "PieceType", "ETADateTime", "No40", "DoorETADateTime", "Shipper", "FileType", "POInputDate", "CODAmount", "UNContactNumber", "Master", "LoadingDock", "PortOfDischarge", "UNFlag", "RoutingParty", "No20", "Voyage", "DeliveryAddress", "Liftgate", "PickupDateTime", "HazardousDescription", "Consignee", "MasterId", "FileId", "Forklift", "Notes", "ContactPhoneFax", "LastFreeDayDateTime", "OblRequired", "CustomsEntryNumber", "Kilos", "MasterNumber", "Notify", "TypeOfMove", "BookingNumber", "GoDateDateTime", "ConfirmedDepartureDate", "Account", "FORWARDERSRE", "DateFileOpen", "CargoLocation", "InBondNumber", "ReadyDateTime", "UltimateDestination", "ITDate", "Conveyance", "CustomerReferenceNumber", "CreatedDateTime", "TEU", "Upstairs", "EntryFiledDate", "Vessel", "HouseNumber", "CODFlag", "Pounds", "SiteId", "DeliveredDateTime", "PODate", "Downstairs", "CBM", "ClosingDateTime", "CompletedFlag", "ContactName", "ContactEmail", "ReturnDate", "Forwarder", "ClientId", "PickupAt", "PlaceOfDelivery", "Status", "Cartons", "Carrier", "UN_Number", "BookedDateTime", "PortOfLoad", "CutoffDateTime", "SailDateTime");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("StatusCode", "RequestedDeliveryDateTime", "ContactFax", "ConfirmedArrivalDate", "FileNumber", "Commodity", "ThirdParty", "No40HC", "PlaceOfReceipt", "ServiceType", "ShipmentId", "LCLFlag", "Pieces", "CFT", "ClearedDateTime", "Module", "ReeferTemperature", "PieceType", "ETADateTime", "No40", "DoorETADateTime", "Shipper", "FileType", "POInputDate", "CODAmount", "UNContactNumber", "Master", "LoadingDock", "PortOfDischarge", "UNFlag", "RoutingParty", "No20", "Voyage", "DeliveryAddress", "Liftgate", "PickupDateTime", "HazardousDescription", "Consignee", "MasterId", "FileId", "Forklift", "Notes", "ContactPhoneFax", "LastFreeDayDateTime", "OblRequired", "CustomsEntryNumber", "Kilos", "MasterNumber", "Notify", "TypeOfMove", "BookingNumber", "GoDateDateTime", "ConfirmedDepartureDate", "Account", "FORWARDERSRE", "DateFileOpen", "CargoLocation", "InBondNumber", "ReadyDateTime", "UltimateDestination", "ITDate", "Conveyance", "CustomerReferenceNumber", "CreatedDateTime", "TEU", "Upstairs", "EntryFiledDate", "Vessel", "HouseNumber", "CODFlag", "Pounds", "SiteId", "DeliveredDateTime", "PODate", "Downstairs", "CBM", "ClosingDateTime", "CompletedFlag", "ContactName", "ContactEmail", "ReturnDate", "Forwarder", "ClientId", "PickupAt", "PlaceOfDelivery", "Status", "Cartons", "Carrier", "UN_Number", "BookedDateTime", "PortOfLoad", "CutoffDateTime", "SailDateTime");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("StatusCode", "RequestedDeliveryDateTime", "ContactFax", "ConfirmedArrivalDate", "FileNumber", "Commodity", "ThirdParty", "No40HC", "PlaceOfReceipt", "ServiceType", "ShipmentId", "LCLFlag", "Pieces", "CFT", "ClearedDateTime", "Module", "ReeferTemperature", "PieceType", "ETADateTime", "No40", "DoorETADateTime", "Shipper", "FileType", "POInputDate", "CODAmount", "UNContactNumber", "Master", "LoadingDock", "PortOfDischarge", "UNFlag", "RoutingParty", "No20", "Voyage", "DeliveryAddress", "Liftgate", "PickupDateTime", "HazardousDescription", "Consignee", "MasterId", "FileId", "Forklift", "Notes", "ContactPhoneFax", "LastFreeDayDateTime", "OblRequired", "CustomsEntryNumber", "Kilos", "MasterNumber", "Notify", "TypeOfMove", "BookingNumber", "GoDateDateTime", "ConfirmedDepartureDate", "Account", "FORWARDERSRE", "DateFileOpen", "CargoLocation", "InBondNumber", "ReadyDateTime", "UltimateDestination", "ITDate", "Conveyance", "CustomerReferenceNumber", "CreatedDateTime", "TEU", "Upstairs", "EntryFiledDate", "Vessel", "HouseNumber", "CODFlag", "Pounds", "SiteId", "DeliveredDateTime", "PODate", "Downstairs", "CBM", "ClosingDateTime", "CompletedFlag", "ContactName", "ContactEmail", "ReturnDate", "Forwarder", "ClientId", "PickupAt", "PlaceOfDelivery", "Status", "Cartons", "Carrier", "UN_Number", "BookedDateTime", "PortOfLoad", "CutoffDateTime", "SailDateTime");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("StatusCode", "RequestedDeliveryDateTime", "ContactFax", "ConfirmedArrivalDate", "FileNumber", "Commodity", "ThirdParty", "No40HC", "PlaceOfReceipt", "ServiceType", "ShipmentId", "LCLFlag", "Pieces", "CFT", "ClearedDateTime", "Module", "ReeferTemperature", "PieceType", "ETADateTime", "No40", "DoorETADateTime", "Shipper", "FileType", "POInputDate", "CODAmount", "UNContactNumber", "Master", "LoadingDock", "PortOfDischarge", "UNFlag", "RoutingParty", "No20", "Voyage", "DeliveryAddress", "Liftgate", "PickupDateTime", "HazardousDescription", "Consignee", "MasterId", "FileId", "Forklift", "Notes", "ContactPhoneFax", "LastFreeDayDateTime", "OblRequired", "CustomsEntryNumber", "Kilos", "MasterNumber", "Notify", "TypeOfMove", "BookingNumber", "GoDateDateTime", "ConfirmedDepartureDate", "Account", "FORWARDERSRE", "DateFileOpen", "CargoLocation", "InBondNumber", "ReadyDateTime", "UltimateDestination", "ITDate", "Conveyance", "CustomerReferenceNumber", "CreatedDateTime", "TEU", "Upstairs", "EntryFiledDate", "Vessel", "HouseNumber", "CODFlag", "Pounds", "SiteId", "DeliveredDateTime", "PODate", "Downstairs", "CBM", "ClosingDateTime", "CompletedFlag", "ContactName", "ContactEmail", "ReturnDate", "Forwarder", "ClientId", "PickupAt", "PlaceOfDelivery", "Status", "Cartons", "Carrier", "UN_Number", "BookedDateTime", "PortOfLoad", "CutoffDateTime", "SailDateTime");
    model_internal static var sourceProperties:Array = emptyArray
    model_internal static var nonDerivedProperties:Array = new Array("StatusCode", "RequestedDeliveryDateTime", "ContactFax", "ConfirmedArrivalDate", "FileNumber", "Commodity", "ThirdParty", "No40HC", "PlaceOfReceipt", "ServiceType", "ShipmentId", "LCLFlag", "Pieces", "CFT", "ClearedDateTime", "Module", "ReeferTemperature", "PieceType", "ETADateTime", "No40", "DoorETADateTime", "Shipper", "FileType", "POInputDate", "CODAmount", "UNContactNumber", "Master", "LoadingDock", "PortOfDischarge", "UNFlag", "RoutingParty", "No20", "Voyage", "DeliveryAddress", "Liftgate", "PickupDateTime", "HazardousDescription", "Consignee", "MasterId", "FileId", "Forklift", "Notes", "ContactPhoneFax", "LastFreeDayDateTime", "OblRequired", "CustomsEntryNumber", "Kilos", "MasterNumber", "Notify", "TypeOfMove", "BookingNumber", "GoDateDateTime", "ConfirmedDepartureDate", "Account", "FORWARDERSRE", "DateFileOpen", "CargoLocation", "InBondNumber", "ReadyDateTime", "UltimateDestination", "ITDate", "Conveyance", "CustomerReferenceNumber", "CreatedDateTime", "TEU", "Upstairs", "EntryFiledDate", "Vessel", "HouseNumber", "CODFlag", "Pounds", "SiteId", "DeliveredDateTime", "PODate", "Downstairs", "CBM", "ClosingDateTime", "CompletedFlag", "ContactName", "ContactEmail", "ReturnDate", "Forwarder", "ClientId", "PickupAt", "PlaceOfDelivery", "Status", "Cartons", "Carrier", "UN_Number", "BookedDateTime", "PortOfLoad", "CutoffDateTime", "SailDateTime");
    model_internal static var derivedProperties:Array = new Array();
    model_internal static var collectionProperties:Array = new Array();
    model_internal static var collectionBaseMap:Object;
    model_internal static var entityName:String = "ShipmentResultData";
    ...
    model_internal var _LCLFlagIsValid:Boolean;
    model_internal var _LCLFlagValidator:com.adobe.fiber.styles.StyleValidator;
    model_internal var _LCLFlagIsValidCacheInitialized:Boolean = false;
    model_internal var _LCLFlagValidationFailureMessages:Array;
    ...
    model_internal var _LoadingDockIsValid:Boolean;
    model_internal var _LoadingDockValidator:com.adobe.fiber.styles.StyleValidator;
    model_internal var _LoadingDockIsValidCacheInitialized:Boolean = false;
    model_internal var _LoadingDockValidationFailureMessages:Array;
    ...
    model_internal var _UNFlagIsValid:Boolean;
    model_internal var _UNFlagValidator:com.adobe.fiber.styles.StyleValidator;
    model_internal var _UNFlagIsValidCacheInitialized:Boolean = false;
    model_internal var _UNFlagValidationFailureMessages:Array;
    ...
    model_internal var _LiftgateIsValid:Boolean;
    model_internal var _LiftgateValidator:com.adobe.fiber.styles.StyleValidator;
    model_internal var _LiftgateIsValidCacheInitialized:Boolean = false;
    model_internal var _LiftgateValidationFailureMessages:Array;
    ...
    model_internal var _ForkliftIsValid:Boolean;
    model_internal var _ForkliftValidator:com.adobe.fiber.styles.StyleValidator;
    model_internal var _ForkliftIsValidCacheInitialized:Boolean = false;
    model_internal var _ForkliftValidationFailureMessages:Array;
    ...
    model_internal var _UpstairsIsValid:Boolean;
    model_internal var _UpstairsValidator:com.adobe.fiber.styles.StyleValidator;
    model_internal var _UpstairsIsValidCacheInitialized:Boolean = false;
    model_internal var _UpstairsValidationFailureMessages:Array;
    ...
    model_internal var _CODFlagIsValid:Boolean;
    model_internal var _CODFlagValidator:com.adobe.fiber.styles.StyleValidator;
    model_internal var _CODFlagIsValidCacheInitialized:Boolean = false;
    model_internal var _CODFlagValidationFailureMessages:Array;
    ...
    model_internal var _DownstairsIsValid:Boolean;
    model_internal var _DownstairsValidator:com.adobe.fiber.styles.StyleValidator;
    model_internal var _DownstairsIsValidCacheInitialized:Boolean = false;
    model_internal var _DownstairsValidationFailureMessages:Array;
    ...
    model_internal var _instance:_Super_ShipmentResultData;
    model_internal static var _nullStyle:com.adobe.fiber.styles.Style = new com.adobe.fiber.styles.Style();

    public function _ShipmentResultDataEntityMetadata(value : _Super_ShipmentResultData)
    {
        ...
        model_internal::propertyTypeMap["LCLFlag"] = "String";
        ...
        model_internal::propertyTypeMap["ETADateTime"] = "Object";
        ...
        model_internal::propertyTypeMap["LoadingDock"] = "String";
        model_internal::propertyTypeMap["PortOfDischarge"] = "String";
        model_internal::propertyTypeMap["UNFlag"] = "String";
        ...
        model_internal::propertyTypeMap["Liftgate"] = "String";
        ...
        model_internal::propertyTypeMap["Forklift"] = "String";
        ...
        model_internal::propertyTypeMap["DateFileOpen"] = "Object";
        ...
        model_internal::propertyTypeMap["Upstairs"] = "String";
        ...
        model_internal::propertyTypeMap["CODFlag"] = "String";
        model_internal::propertyTypeMap["Pounds"] = "String";
        model_internal::propertyTypeMap["SiteId"] = "String";
        model_internal::propertyTypeMap["DeliveredDateTime"] = "Object";
        model_internal::propertyTypeMap["PODate"] = "Object";
        model_internal::propertyTypeMap["Downstairs"] = "String";
        ...
        model_internal::_LCLFlagValidator = new StyleValidator(model_internal::_instance.model_internal::_doValidationForLCLFlag);
        model_internal::_LCLFlagValidator.required = true;
        model_internal::_LCLFlagValidator.requiredFieldError = "LCLFlag is required";
        //model_internal::_LCLFlagValidator.source = model_internal::_instance;
        //model_internal::_LCLFlagValidator.property = "LCLFlag";
        ...
        model_internal::_LoadingDockValidator = new StyleValidator(model_internal::_instance.model_internal::_doValidationForLoadingDock);
        model_internal::_LoadingDockValidator.required = true;
        model_internal::_LoadingDockValidator.requiredFieldError = "LoadingDock is required";
        //model_internal::_LoadingDockValidator.source = model_internal::_instance;
        //model_internal::_LoadingDockValidator.property = "LoadingDock";
        ...
        model_internal::_UNFlagValidator = new StyleValidator(model_internal::_instance.model_internal::_doValidationForUNFlag);
        model_internal::_UNFlagValidator.required = true;
        model_internal::_UNFlagValidator.requiredFieldError = "UNFlag is required";
        //model_internal::_UNFlagValidator.source = model_internal::_instance;
        //model_internal::_UNFlagValidator.property = "UNFlag";
        ...
        model_internal::_LiftgateValidator = new StyleValidator(model_internal::_instance.model_internal::_doValidationForLiftgate);
        model_internal::_LiftgateValidator.required = true;
        model_internal::_LiftgateValidator.requiredFieldError = "Liftgate is required";
        //model_internal::_LiftgateValidator.source = model_internal::_instance;
        //model_internal::_LiftgateValidator.property = "Liftgate";
        ...
        model_internal::_ForkliftValidator = new StyleValidator(model_internal::_instance.model_internal::_doValidationForForklift);
        model_internal::_ForkliftValidator.required = true;
        model_internal::_ForkliftValidator.requiredFieldError = "Forklift is required";
        //model_internal::_ForkliftValidator.source = model_internal::_instance;
        //model_internal::_ForkliftValidator.property = "Forklift";
        ...
        model_internal::_UpstairsValidator = new StyleValidator(model_internal::_instance.model_internal::_doValidationForUpstairs);
        model_internal::_UpstairsValidator.required = true;
        model_internal::_UpstairsValidator.requiredFieldError = "Upstairs is required";
        //model_internal::_UpstairsValidator.source = model_internal::_instance;
        //model_internal::_UpstairsValidator.property = "Upstairs";
        ...
        model_internal::_CODFlagValidator = new StyleValidator(model_internal::_instance.model_internal::_doValidationForCODFlag);
        model_internal::_CODFlagValidator.required = true;
        model_internal::_CODFlagValidator.requiredFieldError = "CODFlag is required";
        //model_internal::_CODFlagValidator.source = model_internal::_instance;
        //model_internal::_CODFlagValidator.property = "CODFlag";
        ...
        model_internal::_DownstairsValidator = new StyleValidator(model_internal::_instance.model_internal::_doValidationForDownstairs);
        model_internal::_DownstairsValidator.required = true;
        model_internal::_DownstairsValidator.requiredFieldError = "Downstairs is required";
        //model_internal::_DownstairsValidator.source = model_internal::_instance;
        //model_internal::_DownstairsValidator.property = "Downstairs";
    ...
    override public function getDependants(propertyName:String):Array
    {
       if (model_internal::nonDerivedProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a data property of entity ShipmentResultData");
    ...
    override public function getCollectionBase(propertyName:String):String
    {
        if (model_internal::collectionProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a collection property of entity ShipmentResultData");
    ...
    override public function getPropertyType(propertyName:String):String
    {
        if (model_internal::allProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a property of ShipmentResultData");
    ...
    override public function getValue(propertyName:String):*
    {
        if (model_internal::allProperties.indexOf(propertyName) == -1)
        {
            throw new Error(propertyName + " does not exist for entity ShipmentResultData");
        }
    ...
    override public function setValue(propertyName:String, value:*):void
    {
        if (model_internal::nonDerivedProperties.indexOf(propertyName) == -1)
        {
            throw new Error(propertyName + " is not a modifiable property of entity ShipmentResultData");
        }
    ...
    public function invalidateDependentOnLCLFlag():void
    {
        if (model_internal::_LCLFlagIsValidCacheInitialized )
        {
            model_internal::_instance.model_internal::_doValidationCacheOfLCLFlag = null;
            model_internal::calculateLCLFlagIsValid();
        }
    }
    ...
    public function invalidateDependentOnLoadingDock():void
    {
        if (model_internal::_LoadingDockIsValidCacheInitialized )
        {
            model_internal::_instance.model_internal::_doValidationCacheOfLoadingDock = null;
            model_internal::calculateLoadingDockIsValid();
        }
    }
    ...
    public function invalidateDependentOnUNFlag():void
    {
        if (model_internal::_UNFlagIsValidCacheInitialized )
        {
            model_internal::_instance.model_internal::_doValidationCacheOfUNFlag = null;
            model_internal::calculateUNFlagIsValid();
        }
    }
    ...
    public function invalidateDependentOnLiftgate():void
    {
        if (model_internal::_LiftgateIsValidCacheInitialized )
        {
            model_internal::_instance.model_internal::_doValidationCacheOfLiftgate = null;
            model_internal::calculateLiftgateIsValid();
        }
    }
    ...
    public function invalidateDependentOnForklift():void
    {
        if (model_internal::_ForkliftIsValidCacheInitialized )
        {
            model_internal::_instance.model_internal::_doValidationCacheOfForklift = null;
            model_internal::calculateForkliftIsValid();
        }
    }
    ...
    public function invalidateDependentOnUpstairs():void
    {
        if (model_internal::_UpstairsIsValidCacheInitialized )
        {
            model_internal::_instance.model_internal::_doValidationCacheOfUpstairs = null;
            model_internal::calculateUpstairsIsValid();
        }
    }
    ...
    public function invalidateDependentOnCODFlag():void
    {
        if (model_internal::_CODFlagIsValidCacheInitialized )
        {
            model_internal::_instance.model_internal::_doValidationCacheOfCODFlag = null;
            model_internal::calculateCODFlagIsValid();
        }
    }
    ...
    public function invalidateDependentOnDownstairs():void
    {
        if (model_internal::_DownstairsIsValidCacheInitialized )
        {
            model_internal::_instance.model_internal::_doValidationCacheOfDownstairs = null;
            model_internal::calculateDownstairsIsValid();
        }
    }
    ...
    public function get LCLFlagValidator() : StyleValidator
    {
        return model_internal::_LCLFlagValidator;
    }

    model_internal function set _LCLFlagIsValid_der(value:Boolean):void 
    {
        var oldValue:Boolean = model_internal::_LCLFlagIsValid;         
        if (oldValue !== value)
        {
            model_internal::_LCLFlagIsValid = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "LCLFlagIsValid", oldValue, value));
        }                             
    }

    [Bindable(event="propertyChange")]
    public function get LCLFlagIsValid():Boolean
    {
        if (!model_internal::_LCLFlagIsValidCacheInitialized)
        {
            model_internal::calculateLCLFlagIsValid();
        ...
        return model_internal::_LCLFlagIsValid;
    }

    model_internal function calculateLCLFlagIsValid():void
    {
        var valRes:ValidationResultEvent = model_internal::_LCLFlagValidator.validate(model_internal::_instance.LCLFlag)
        model_internal::_LCLFlagIsValid_der = (valRes.results == null);
        model_internal::_LCLFlagIsValidCacheInitialized = true;
        if (valRes.results == null)
             model_internal::LCLFlagValidationFailureMessages_der = emptyArray;
        else
        {
            var _valFailures:Array = new Array();
            for (var a:int = 0 ; a<valRes.results.length ; a++)
            ...
            model_internal::LCLFlagValidationFailureMessages_der = _valFailures;
        }
    }

    [Bindable(event="propertyChange")]
    public function get LCLFlagValidationFailureMessages():Array
    {
        if (model_internal::_LCLFlagValidationFailureMessages == null)
            model_internal::calculateLCLFlagIsValid();

        return _LCLFlagValidationFailureMessages;
    }

    model_internal function set LCLFlagValidationFailureMessages_der(value:Array) : void
    {
        var oldValue:Array = model_internal::_LCLFlagValidationFailureMessages;
        ...
        if (needUpdate)
        {
            model_internal::_LCLFlagValidationFailureMessages = value;   
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "LCLFlagValidationFailureMessages", oldValue, value));
            // Only execute calculateIsValid if it has been called before, to update the validationFailureMessages for
            // the entire entity.
            if (model_internal::_instance.model_internal::_cacheInitialized_isValid)
            {
    ...
    public function get LoadingDockValidator() : StyleValidator
    {
        return model_internal::_LoadingDockValidator;
    }

    model_internal function set _LoadingDockIsValid_der(value:Boolean):void 
    {
        var oldValue:Boolean = model_internal::_LoadingDockIsValid;         
        if (oldValue !== value)
        {
            model_internal::_LoadingDockIsValid = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "LoadingDockIsValid", oldValue, value));
        }                             
    }

    [Bindable(event="propertyChange")]
    public function get LoadingDockIsValid():Boolean
    {
        if (!model_internal::_LoadingDockIsValidCacheInitialized)
        {
            model_internal::calculateLoadingDockIsValid();
        ...
        return model_internal::_LoadingDockIsValid;
    }

    model_internal function calculateLoadingDockIsValid():void
    {
        var valRes:ValidationResultEvent = model_internal::_LoadingDockValidator.validate(model_internal::_instance.LoadingDock)
        model_internal::_LoadingDockIsValid_der = (valRes.results == null);
        model_internal::_LoadingDockIsValidCacheInitialized = true;
        if (valRes.results == null)
             model_internal::LoadingDockValidationFailureMessages_der = emptyArray;
        else
        {
            var _valFailures:Array = new Array();
            for (var a:int = 0 ; a<valRes.results.length ; a++)
            ...
            model_internal::LoadingDockValidationFailureMessages_der = _valFailures;
        }
    }

    [Bindable(event="propertyChange")]
    public function get LoadingDockValidationFailureMessages():Array
    {
        if (model_internal::_LoadingDockValidationFailureMessages == null)
            model_internal::calculateLoadingDockIsValid();

        return _LoadingDockValidationFailureMessages;
    }

    model_internal function set LoadingDockValidationFailureMessages_der(value:Array) : void
    {
        var oldValue:Array = model_internal::_LoadingDockValidationFailureMessages;
        ...
        if (needUpdate)
        {
            model_internal::_LoadingDockValidationFailureMessages = value;   
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "LoadingDockValidationFailureMessages", oldValue, value));
            // Only execute calculateIsValid if it has been called before, to update the validationFailureMessages for
            // the entire entity.
            if (model_internal::_instance.model_internal::_cacheInitialized_isValid)
            {
    ...
    public function get UNFlagValidator() : StyleValidator
    {
        return model_internal::_UNFlagValidator;
    }

    model_internal function set _UNFlagIsValid_der(value:Boolean):void 
    {
        var oldValue:Boolean = model_internal::_UNFlagIsValid;         
        if (oldValue !== value)
        {
            model_internal::_UNFlagIsValid = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "UNFlagIsValid", oldValue, value));
        }                             
    }

    [Bindable(event="propertyChange")]
    public function get UNFlagIsValid():Boolean
    {
        if (!model_internal::_UNFlagIsValidCacheInitialized)
        {
            model_internal::calculateUNFlagIsValid();
        ...
        return model_internal::_UNFlagIsValid;
    }

    model_internal function calculateUNFlagIsValid():void
    {
        var valRes:ValidationResultEvent = model_internal::_UNFlagValidator.validate(model_internal::_instance.UNFlag)
        model_internal::_UNFlagIsValid_der = (valRes.results == null);
        model_internal::_UNFlagIsValidCacheInitialized = true;
        if (valRes.results == null)
             model_internal::UNFlagValidationFailureMessages_der = emptyArray;
        else
        {
            var _valFailures:Array = new Array();
            for (var a:int = 0 ; a<valRes.results.length ; a++)
            ...
            model_internal::UNFlagValidationFailureMessages_der = _valFailures;
        }
    }

    [Bindable(event="propertyChange")]
    public function get UNFlagValidationFailureMessages():Array
    {
        if (model_internal::_UNFlagValidationFailureMessages == null)
            model_internal::calculateUNFlagIsValid();

        return _UNFlagValidationFailureMessages;
    }

    model_internal function set UNFlagValidationFailureMessages_der(value:Array) : void
    {
        var oldValue:Array = model_internal::_UNFlagValidationFailureMessages;
        ...
        if (needUpdate)
        {
            model_internal::_UNFlagValidationFailureMessages = value;   
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "UNFlagValidationFailureMessages", oldValue, value));
            // Only execute calculateIsValid if it has been called before, to update the validationFailureMessages for
            // the entire entity.
            if (model_internal::_instance.model_internal::_cacheInitialized_isValid)
            {
    ...
    public function get LiftgateValidator() : StyleValidator
    {
        return model_internal::_LiftgateValidator;
    }

    model_internal function set _LiftgateIsValid_der(value:Boolean):void 
    {
        var oldValue:Boolean = model_internal::_LiftgateIsValid;         
        if (oldValue !== value)
        {
            model_internal::_LiftgateIsValid = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "LiftgateIsValid", oldValue, value));
        }                             
    }

    [Bindable(event="propertyChange")]
    public function get LiftgateIsValid():Boolean
    {
        if (!model_internal::_LiftgateIsValidCacheInitialized)
        {
            model_internal::calculateLiftgateIsValid();
        ...
        return model_internal::_LiftgateIsValid;
    }

    model_internal function calculateLiftgateIsValid():void
    {
        var valRes:ValidationResultEvent = model_internal::_LiftgateValidator.validate(model_internal::_instance.Liftgate)
        model_internal::_LiftgateIsValid_der = (valRes.results == null);
        model_internal::_LiftgateIsValidCacheInitialized = true;
        if (valRes.results == null)
             model_internal::LiftgateValidationFailureMessages_der = emptyArray;
        else
        {
            var _valFailures:Array = new Array();
            for (var a:int = 0 ; a<valRes.results.length ; a++)
            ...
            model_internal::LiftgateValidationFailureMessages_der = _valFailures;
        }
    }

    [Bindable(event="propertyChange")]
    public function get LiftgateValidationFailureMessages():Array
    {
        if (model_internal::_LiftgateValidationFailureMessages == null)
            model_internal::calculateLiftgateIsValid();

        return _LiftgateValidationFailureMessages;
    }

    model_internal function set LiftgateValidationFailureMessages_der(value:Array) : void
    {
        var oldValue:Array = model_internal::_LiftgateValidationFailureMessages;
        ...
        if (needUpdate)
        {
            model_internal::_LiftgateValidationFailureMessages = value;   
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "LiftgateValidationFailureMessages", oldValue, value));
            // Only execute calculateIsValid if it has been called before, to update the validationFailureMessages for
            // the entire entity.
            if (model_internal::_instance.model_internal::_cacheInitialized_isValid)
            {
    ...
    public function get ForkliftValidator() : StyleValidator
    {
        return model_internal::_ForkliftValidator;
    }

    model_internal function set _ForkliftIsValid_der(value:Boolean):void 
    {
        var oldValue:Boolean = model_internal::_ForkliftIsValid;         
        if (oldValue !== value)
        {
            model_internal::_ForkliftIsValid = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "ForkliftIsValid", oldValue, value));
        }                             
    }

    [Bindable(event="propertyChange")]
    public function get ForkliftIsValid():Boolean
    {
        if (!model_internal::_ForkliftIsValidCacheInitialized)
        {
            model_internal::calculateForkliftIsValid();
        ...
        return model_internal::_ForkliftIsValid;
    }

    model_internal function calculateForkliftIsValid():void
    {
        var valRes:ValidationResultEvent = model_internal::_ForkliftValidator.validate(model_internal::_instance.Forklift)
        model_internal::_ForkliftIsValid_der = (valRes.results == null);
        model_internal::_ForkliftIsValidCacheInitialized = true;
        if (valRes.results == null)
             model_internal::ForkliftValidationFailureMessages_der = emptyArray;
        else
        {
            var _valFailures:Array = new Array();
            for (var a:int = 0 ; a<valRes.results.length ; a++)
            ...
            model_internal::ForkliftValidationFailureMessages_der = _valFailures;
        }
    }

    [Bindable(event="propertyChange")]
    public function get ForkliftValidationFailureMessages():Array
    {
        if (model_internal::_ForkliftValidationFailureMessages == null)
            model_internal::calculateForkliftIsValid();

        return _ForkliftValidationFailureMessages;
    }

    model_internal function set ForkliftValidationFailureMessages_der(value:Array) : void
    {
        var oldValue:Array = model_internal::_ForkliftValidationFailureMessages;
        ...
        if (needUpdate)
        {
            model_internal::_ForkliftValidationFailureMessages = value;   
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "ForkliftValidationFailureMessages", oldValue, value));
            // Only execute calculateIsValid if it has been called before, to update the validationFailureMessages for
            // the entire entity.
            if (model_internal::_instance.model_internal::_cacheInitialized_isValid)
            {
    ...
    public function get UpstairsValidator() : StyleValidator
    {
        return model_internal::_UpstairsValidator;
    }

    model_internal function set _UpstairsIsValid_der(value:Boolean):void 
    {
        var oldValue:Boolean = model_internal::_UpstairsIsValid;         
        if (oldValue !== value)
        {
            model_internal::_UpstairsIsValid = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "UpstairsIsValid", oldValue, value));
        }                             
    }

    [Bindable(event="propertyChange")]
    public function get UpstairsIsValid():Boolean
    {
        if (!model_internal::_UpstairsIsValidCacheInitialized)
        {
            model_internal::calculateUpstairsIsValid();
        ...
        return model_internal::_UpstairsIsValid;
    }

    model_internal function calculateUpstairsIsValid():void
    {
        var valRes:ValidationResultEvent = model_internal::_UpstairsValidator.validate(model_internal::_instance.Upstairs)
        model_internal::_UpstairsIsValid_der = (valRes.results == null);
        model_internal::_UpstairsIsValidCacheInitialized = true;
        if (valRes.results == null)
             model_internal::UpstairsValidationFailureMessages_der = emptyArray;
        else
        {
            var _valFailures:Array = new Array();
            for (var a:int = 0 ; a<valRes.results.length ; a++)
            ...
            model_internal::UpstairsValidationFailureMessages_der = _valFailures;
        }
    }

    [Bindable(event="propertyChange")]
    public function get UpstairsValidationFailureMessages():Array
    {
        if (model_internal::_UpstairsValidationFailureMessages == null)
            model_internal::calculateUpstairsIsValid();

        return _UpstairsValidationFailureMessages;
    }

    model_internal function set UpstairsValidationFailureMessages_der(value:Array) : void
    {
        var oldValue:Array = model_internal::_UpstairsValidationFailureMessages;
        ...
        if (needUpdate)
        {
            model_internal::_UpstairsValidationFailureMessages = value;   
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "UpstairsValidationFailureMessages", oldValue, value));
            // Only execute calculateIsValid if it has been called before, to update the validationFailureMessages for
            // the entire entity.
            if (model_internal::_instance.model_internal::_cacheInitialized_isValid)
            {
    ...
    public function get CODFlagValidator() : StyleValidator
    {
        return model_internal::_CODFlagValidator;
    }

    model_internal function set _CODFlagIsValid_der(value:Boolean):void 
    {
        var oldValue:Boolean = model_internal::_CODFlagIsValid;         
        if (oldValue !== value)
        {
            model_internal::_CODFlagIsValid = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "CODFlagIsValid", oldValue, value));
        }                             
    }

    [Bindable(event="propertyChange")]
    public function get CODFlagIsValid():Boolean
    {
        if (!model_internal::_CODFlagIsValidCacheInitialized)
        {
            model_internal::calculateCODFlagIsValid();
        ...
        return model_internal::_CODFlagIsValid;
    }

    model_internal function calculateCODFlagIsValid():void
    {
        var valRes:ValidationResultEvent = model_internal::_CODFlagValidator.validate(model_internal::_instance.CODFlag)
        model_internal::_CODFlagIsValid_der = (valRes.results == null);
        model_internal::_CODFlagIsValidCacheInitialized = true;
        if (valRes.results == null)
             model_internal::CODFlagValidationFailureMessages_der = emptyArray;
        else
        {
            var _valFailures:Array = new Array();
            for (var a:int = 0 ; a<valRes.results.length ; a++)
            ...
            model_internal::CODFlagValidationFailureMessages_der = _valFailures;
        }
    }

    [Bindable(event="propertyChange")]
    public function get CODFlagValidationFailureMessages():Array
    {
        if (model_internal::_CODFlagValidationFailureMessages == null)
            model_internal::calculateCODFlagIsValid();

        return _CODFlagValidationFailureMessages;
    }

    model_internal function set CODFlagValidationFailureMessages_der(value:Array) : void
    {
        var oldValue:Array = model_internal::_CODFlagValidationFailureMessages;
        ...
        if (needUpdate)
        {
            model_internal::_CODFlagValidationFailureMessages = value;   
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "CODFlagValidationFailureMessages", oldValue, value));
            // Only execute calculateIsValid if it has been called before, to update the validationFailureMessages for
            // the entire entity.
            if (model_internal::_instance.model_internal::_cacheInitialized_isValid)
            {
    ...
    public function get DownstairsValidator() : StyleValidator
    {
        return model_internal::_DownstairsValidator;
    }

    model_internal function set _DownstairsIsValid_der(value:Boolean):void 
    {
        var oldValue:Boolean = model_internal::_DownstairsIsValid;         
        if (oldValue !== value)
        {
            model_internal::_DownstairsIsValid = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "DownstairsIsValid", oldValue, value));
        }                             
    }

    [Bindable(event="propertyChange")]
    public function get DownstairsIsValid():Boolean
    {
        if (!model_internal::_DownstairsIsValidCacheInitialized)
        {
            model_internal::calculateDownstairsIsValid();
        ...
        return model_internal::_DownstairsIsValid;
    }

    model_internal function calculateDownstairsIsValid():void
    {
        var valRes:ValidationResultEvent = model_internal::_DownstairsValidator.validate(model_internal::_instance.Downstairs)
        model_internal::_DownstairsIsValid_der = (valRes.results == null);
        model_internal::_DownstairsIsValidCacheInitialized = true;
        if (valRes.results == null)
             model_internal::DownstairsValidationFailureMessages_der = emptyArray;
        else
        {
            var _valFailures:Array = new Array();
            for (var a:int = 0 ; a<valRes.results.length ; a++)
            ...
            model_internal::DownstairsValidationFailureMessages_der = _valFailures;
        }
    }

    [Bindable(event="propertyChange")]
    public function get DownstairsValidationFailureMessages():Array
    {
        if (model_internal::_DownstairsValidationFailureMessages == null)
            model_internal::calculateDownstairsIsValid();

        return _DownstairsValidationFailureMessages;
    }

    model_internal function set DownstairsValidationFailureMessages_der(value:Array) : void
    {
        var oldValue:Array = model_internal::_DownstairsValidationFailureMessages;
        ...
        if (needUpdate)
        {
            model_internal::_DownstairsValidationFailureMessages = value;   
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "DownstairsValidationFailureMessages", oldValue, value));
            // Only execute calculateIsValid if it has been called before, to update the validationFailureMessages for
            // the entire entity.
            if (model_internal::_instance.model_internal::_cacheInitialized_isValid)
            {
     ...
     */  
     override public function getPropertyValidationFailureMessages(propertyName:String):Array
     {
         switch(propertyName)
         {
            ...
            case("LCLFlag"):
            {
                return LCLFlagValidationFailureMessages;
            }
            case("Pieces"):
            {
            ...
            case("LoadingDock"):
            {
                return LoadingDockValidationFailureMessages;
            }
            ...
            case("UNFlag"):
            {
                return UNFlagValidationFailureMessages;
            }
            case("RoutingParty"):
            {
            ...
            case("Liftgate"):
            {
                return LiftgateValidationFailureMessages;
            }
            case("PickupDateTime"):
            {
            ...
            case("Forklift"):
            {
                return ForkliftValidationFailureMessages;
            }
            case("Notes"):
            {
            ...
            case("Upstairs"):
            {
                return UpstairsValidationFailureMessages;
            }
            case("EntryFiledDate"):
            {
            ...
            case("CODFlag"):
            {
                return CODFlagValidationFailureMessages;
            }
            case("Pounds"):
            {
            ...
            case("Downstairs"):
            {
                return DownstairsValidationFailureMessages;
            }
            case("CBM"):
            {
