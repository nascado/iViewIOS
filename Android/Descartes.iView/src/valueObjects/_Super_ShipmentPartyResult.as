 ...
 * of this value object you may modify the generated sub-class of this class - ShipmentPartyResult.as.
 */
...
[ExcludeClass]
public class _Super_ShipmentPartyResult extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    {
        valueObjects.ShipmentPartyData.initRemoteClassAliasSingleChild();
    }

    model_internal var _dminternal_model : _ShipmentPartyResultEntityMetadata;
    ...
    model_internal var _internal_data_leaf:valueObjects.ShipmentPartyData;
    ...
    public function _Super_ShipmentPartyResult()
    {
        _model = new _ShipmentPartyResultEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _ShipmentPartyResultEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _ShipmentPartyResultEntityMetadata) : void
    {
        var oldValue : _ShipmentPartyResultEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
