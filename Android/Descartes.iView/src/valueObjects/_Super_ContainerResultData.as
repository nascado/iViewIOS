 ...
 * of this value object you may modify the generated sub-class of this class - ContainerResultData.as.
 */
...
[ExcludeClass]
public class _Super_ContainerResultData extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    model_internal var _dminternal_model : _ContainerResultDataEntityMetadata;
    ...
    private var _internal_InputNumber : String;
    ...
    public function _Super_ContainerResultData()
    {
        _model = new _ContainerResultDataEntityMetadata(this);
        ...
        model_internal::_changeWatcherArray.push(mx.binding.utils.ChangeWatcher.watch(this, "InputNumber", model_internal::setterListenerInputNumber));
    ...
    [Bindable(event="propertyChange")]
    public function get InputNumber() : String
    {
    ...
    public function set InputNumber(value:String) : void
    {
        var oldValue:String = _internal_InputNumber;
        if (oldValue !== value)
        {
    ...
    model_internal function setterListenerInputNumber(value:flash.events.Event):void
    {
        _model.invalidateDependentOnInputNumber();
    }
    ...
    model_internal function calculateIsValid():Boolean
    {
        ...
        if (!_model.InputNumberIsValid)
        {
            propertyValidity = false;
            com.adobe.fiber.util.FiberUtils.arrayAdd(validationFailureMessages, _model.model_internal::_InputNumberValidationFailureMessages);
        }
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _ContainerResultDataEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _ContainerResultDataEntityMetadata) : void
    {
        var oldValue : _ContainerResultDataEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
    ...
    model_internal var _doValidationCacheOfInputNumber : Array = null;
    model_internal var _doValidationLastValOfInputNumber : String;

    model_internal function _doValidationForInputNumber(valueIn:Object):Array
    {
        var value : String = valueIn as String;

        if (model_internal::_doValidationCacheOfInputNumber != null && model_internal::_doValidationLastValOfInputNumber == value)
           return model_internal::_doValidationCacheOfInputNumber ;

        _model.model_internal::_InputNumberIsValidCacheInitialized = true;
        var validationFailures:Array = new Array();
        var errorMessage:String;
        var failure:Boolean;

        var valRes:ValidationResult;
        if (_model.isInputNumberAvailable && _internal_InputNumber == null)
        {
            validationFailures.push(new ValidationResult(true, "", "", "InputNumber is required"));
        }

        model_internal::_doValidationCacheOfInputNumber = validationFailures;
        model_internal::_doValidationLastValOfInputNumber = value;
