 ...
 * of this value object you may modify the generated sub-class of this class - EquipmentUsageFCLResults.as.
 */
...
[ExcludeClass]
public class _Super_EquipmentUsageFCLResults extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    {
        valueObjects.EquipmentUsageFCLData.initRemoteClassAliasSingleChild();
    }

    model_internal var _dminternal_model : _EquipmentUsageFCLResultsEntityMetadata;
    ...
    model_internal var _internal_data_leaf:valueObjects.EquipmentUsageFCLData;
    ...
    public function _Super_EquipmentUsageFCLResults()
    {
        _model = new _EquipmentUsageFCLResultsEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _EquipmentUsageFCLResultsEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _EquipmentUsageFCLResultsEntityMetadata) : void
    {
        var oldValue : _EquipmentUsageFCLResultsEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
