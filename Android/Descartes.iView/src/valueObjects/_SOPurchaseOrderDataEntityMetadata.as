...
[ExcludeClass]
internal class _SOPurchaseOrderDataEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    private static var emptyArray:Array = new Array();

    model_internal static var allProperties:Array = new Array("PO_Number", "Quantity", "PO_Date", "PO_HeaderId", "RowNumber", "UOM", "PartNumber", "PartDescription");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("PO_Number", "Quantity", "PO_Date", "PO_HeaderId", "RowNumber", "UOM", "PartNumber", "PartDescription");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("PO_Number", "Quantity", "PO_Date", "PO_HeaderId", "RowNumber", "UOM", "PartNumber", "PartDescription");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("PO_Number", "Quantity", "PO_Date", "PO_HeaderId", "RowNumber", "UOM", "PartNumber", "PartDescription");
    model_internal static var sourceProperties:Array = emptyArray
    model_internal static var nonDerivedProperties:Array = new Array("PO_Number", "Quantity", "PO_Date", "PO_HeaderId", "RowNumber", "UOM", "PartNumber", "PartDescription");
    model_internal static var derivedProperties:Array = new Array();
    model_internal static var collectionProperties:Array = new Array();
    model_internal static var collectionBaseMap:Object;
    model_internal static var entityName:String = "SOPurchaseOrderData";
    ...
    model_internal var _instance:_Super_SOPurchaseOrderData;
    model_internal static var _nullStyle:com.adobe.fiber.styles.Style = new com.adobe.fiber.styles.Style();

    public function _SOPurchaseOrderDataEntityMetadata(value : _Super_SOPurchaseOrderData)
    {
        ...
        if (model_internal::dependentsOnMap == null)
        {
            ...
            model_internal::dependentsOnMap["RowNumber"] = new Array();
        ...
        model_internal::propertyTypeMap["RowNumber"] = "int";
    ...
    override public function getDependants(propertyName:String):Array
    {
       if (model_internal::nonDerivedProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a data property of entity SOPurchaseOrderData");
    ...
    override public function getCollectionBase(propertyName:String):String
    {
        if (model_internal::collectionProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a collection property of entity SOPurchaseOrderData");
    ...
    override public function getPropertyType(propertyName:String):String
    {
        if (model_internal::allProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a property of SOPurchaseOrderData");
    ...
    override public function getValue(propertyName:String):*
    {
        if (model_internal::allProperties.indexOf(propertyName) == -1)
        {
            throw new Error(propertyName + " does not exist for entity SOPurchaseOrderData");
        }
    ...
    override public function setValue(propertyName:String, value:*):void
    {
        if (model_internal::nonDerivedProperties.indexOf(propertyName) == -1)
        {
            throw new Error(propertyName + " is not a modifiable property of entity SOPurchaseOrderData");
        }
    ...
    [Bindable(event="propertyChange")]
    public function get isRowNumberAvailable():Boolean
    {
        return true;
    }
    ...
    [Bindable(event="propertyChange")]   
    public function get RowNumberStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }
