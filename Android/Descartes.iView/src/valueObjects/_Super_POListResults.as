 ...
 * of this value object you may modify the generated sub-class of this class - POListResults.as.
 */
...
import valueObjects.POData;
import valueObjects.POMetaData;
...
[ExcludeClass]
public class _Super_POListResults extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    {
        valueObjects.POData.initRemoteClassAliasSingleChild();
        ...
        valueObjects.POMetaData.initRemoteClassAliasSingleChild();
        valueObjects.POSortInfo.initRemoteClassAliasSingleChild();
        valueObjects.POFields.initRemoteClassAliasSingleChild();
    }

    model_internal var _dminternal_model : _POListResultsEntityMetadata;
    ...
    model_internal var _internal_data_leaf:valueObjects.POData;
    private var _internal_metaData : ArrayCollection;
    model_internal var _internal_metaData_leaf:valueObjects.POMetaData;
    ...
    public function _Super_POListResults()
    {
        _model = new _POListResultsEntityMetadata(this);
    ...
    [Bindable(event="propertyChange")]
    public function get metaData() : ArrayCollection
    {
    ...
    {
        var oldValue:ArrayCollection = _internal_metaData;
        if (oldValue !== value)
        {
            if (value is ArrayCollection)
            {
            ...
            {
                _internal_metaData = new ArrayCollection(value);
            }
            else if (value == null)
            {
                _internal_metaData = null;
            }
            else
            {
                throw new Error("value of metaData must be a collection");
            }
    ...
    model_internal function setterListenerMetaData(value:flash.events.Event):void
    {
        if (value is mx.events.PropertyChangeEvent)
        {
            if (mx.events.PropertyChangeEvent(value).newValue)
            {
                mx.events.PropertyChangeEvent(value).newValue.addEventListener(mx.events.CollectionEvent.COLLECTION_CHANGE, model_internal::setterListenerMetaData);
            }
        }
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _POListResultsEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _POListResultsEntityMetadata) : void
    {
        var oldValue : _POListResultsEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
    ...
    model_internal var _doValidationLastValOfMetaData : ArrayCollection;
