 ...
 * of this value object you may modify the generated sub-class of this class - EquipmentUtilizationFCLResults.as.
 */
...
[ExcludeClass]
public class _Super_EquipmentUtilizationFCLResults extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    {
        valueObjects.EquipmentUtilizationFCLData.initRemoteClassAliasSingleChild();
    }

    model_internal var _dminternal_model : _EquipmentUtilizationFCLResultsEntityMetadata;
    ...
    model_internal var _internal_data_leaf:valueObjects.EquipmentUtilizationFCLData;
    ...
    public function _Super_EquipmentUtilizationFCLResults()
    {
        _model = new _EquipmentUtilizationFCLResultsEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _EquipmentUtilizationFCLResultsEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _EquipmentUtilizationFCLResultsEntityMetadata) : void
    {
        var oldValue : _EquipmentUtilizationFCLResultsEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
