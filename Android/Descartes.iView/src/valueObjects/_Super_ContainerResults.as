 ...
 * of this value object you may modify the generated sub-class of this class - ContainerResults.as.
 */
...
[ExcludeClass]
public class _Super_ContainerResults extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    {
        valueObjects.ContainerResultData.initRemoteClassAliasSingleChild();
    }

    model_internal var _dminternal_model : _ContainerResultsEntityMetadata;
    ...
    model_internal var _internal_data_leaf:valueObjects.ContainerResultData;
    ...
    public function _Super_ContainerResults()
    {
        _model = new _ContainerResultsEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _ContainerResultsEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _ContainerResultsEntityMetadata) : void
    {
        var oldValue : _ContainerResultsEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
