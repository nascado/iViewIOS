 ...
 * of this value object you may modify the generated sub-class of this class - Items_type.as.
 */
...
[ExcludeClass]
public class _Super_Items_type extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    model_internal var _dminternal_model : _Items_typeEntityMetadata;
    ...
    public function _Super_Items_type()
    {
        _model = new _Items_typeEntityMetadata(this);
    ...
    public function set CBM(value:int) : void
    {
        var oldValue:int = _internal_CBM;
        if (oldValue !== value)
        {
            _internal_CBM = value;
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _Items_typeEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _Items_typeEntityMetadata) : void
    {
        var oldValue : _Items_typeEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
