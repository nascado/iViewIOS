 ...
 * of this value object you may modify the generated sub-class of this class - ShipmentEventResults.as.
 */
...
[ExcludeClass]
public class _Super_ShipmentEventResults extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    {
        valueObjects.ShipmentEventData.initRemoteClassAliasSingleChild();
    }

    model_internal var _dminternal_model : _ShipmentEventResultsEntityMetadata;
    ...
    model_internal var _internal_data_leaf:valueObjects.ShipmentEventData;
    ...
    public function _Super_ShipmentEventResults()
    {
        _model = new _ShipmentEventResultsEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _ShipmentEventResultsEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _ShipmentEventResultsEntityMetadata) : void
    {
        var oldValue : _ShipmentEventResultsEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
