 ...
 * of this value object you may modify the generated sub-class of this class - GetInTransitResults.as.
 */
...
[ExcludeClass]
public class _Super_GetInTransitResults extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    {
        valueObjects.InTransitData.initRemoteClassAliasSingleChild();
    ...
    model_internal var _dminternal_model : _GetInTransitResultsEntityMetadata;
    ...
    model_internal var _internal_data_leaf:valueObjects.InTransitData;
    ...
    public function _Super_GetInTransitResults()
    {
        _model = new _GetInTransitResultsEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _GetInTransitResultsEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _GetInTransitResultsEntityMetadata) : void
    {
        var oldValue : _GetInTransitResultsEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
