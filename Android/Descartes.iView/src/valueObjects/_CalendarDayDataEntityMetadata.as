...
[ExcludeClass]
internal class _CalendarDayDataEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    private static var emptyArray:Array = new Array();

    model_internal static var allProperties:Array = new Array("StatusCode", "RequestedDeliveryDateTime", "ContactFax", "ConfirmedArrivalDate", "FileNumber", "Commodity", "ThirdParty", "No40HC", "PlaceOfReceipt", "ServiceType", "ShipmentId", "LCLFlag", "Pieces", "CFT", "ClearedDateTime", "Module", "ReeferTemperature", "PieceType", "ETADateTime", "No40", "DoorETADateTime", "Shipper", "FileType", "POInputDate", "CODAmount", "UNContactNumber", "Master", "LoadingDock", "PortOfDischarge", "UNFlag", "RoutingParty", "No20", "Voyage", "DeliveryAddress", "Liftgate", "PickupDateTime", "HazardousDescription", "Consignee", "MasterId", "FileId", "Forklift", "Notes", "ContactPhoneFax", "ShipperName", "LastFreeDayDateTime", "OblRequired", "CustomsEntryNumber", "Kilos", "MasterNumber", "Notify", "TypeOfMove", "BookingNumber", "GoDateDateTime", "ConfirmedDepartureDate", "Account", "FORWARDERSRE", "DateFileOpen", "CargoLocation", "InBondNumber", "ReadyDateTime", "UltimateDestination", "ITDate", "Conveyance", "CustomerReferenceNumber", "CreatedDateTime", "TEU", "Upstairs", "EntryFiledDate", "Vessel", "HouseNumber", "CODFlag", "Pounds", "SiteId", "DeliveredDateTime", "PODate", "Downstairs", "Expander", "CBM", "ClosingDateTime", "CompletedFlag", "ContactName", "ContactEmail", "ReturnDate", "Forwarder", "ClientId", "PickupAt", "PlaceOfDelivery", "Status", "Cartons", "Carrier", "UN_Number", "BookedDateTime", "PortOfLoad", "CutoffDateTime", "SailDateTime");
    ...
    model_internal static var entityName:String = "CalendarDayData";
    ...
    model_internal var _instance:_Super_CalendarDayData;
    model_internal static var _nullStyle:com.adobe.fiber.styles.Style = new com.adobe.fiber.styles.Style();

    public function _CalendarDayDataEntityMetadata(value : _Super_CalendarDayData)
    {
        ...
        if (model_internal::dependentsOnMap == null)
        {
            ...
            model_internal::collectionBaseMap["Expander"] = "valueObjects.CalendarDayExpander";
        }
    ...
    override public function getDependants(propertyName:String):Array
    {
       if (model_internal::nonDerivedProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a data property of entity CalendarDayData");
    ...
    override public function getCollectionBase(propertyName:String):String
    {
        if (model_internal::collectionProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a collection property of entity CalendarDayData");
    ...
    override public function getPropertyType(propertyName:String):String
    {
        if (model_internal::allProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a property of CalendarDayData");
    ...
    override public function getValue(propertyName:String):*
    {
        if (model_internal::allProperties.indexOf(propertyName) == -1)
        {
            throw new Error(propertyName + " does not exist for entity CalendarDayData");
        }
    ...
    override public function setValue(propertyName:String, value:*):void
    {
        if (model_internal::nonDerivedProperties.indexOf(propertyName) == -1)
        {
            throw new Error(propertyName + " is not a modifiable property of entity CalendarDayData");
        }
