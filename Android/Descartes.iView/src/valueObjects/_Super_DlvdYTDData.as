 ...
 * of this value object you may modify the generated sub-class of this class - DlvdYTDData.as.
 */
...
[ExcludeClass]
public class _Super_DlvdYTDData extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    model_internal var _dminternal_model : _DlvdYTDDataEntityMetadata;
    ...
    private var _internal_BookedDateTime : String;
    ...
    public function _Super_DlvdYTDData()
    {
        _model = new _DlvdYTDDataEntityMetadata(this);
    ...
    [Bindable(event="propertyChange")]
    public function get BookedDateTime() : String
    {
    ...
    public function set BookedDateTime(value:String) : void
    {
        var oldValue:String = _internal_BookedDateTime;
        if (oldValue !== value)
        {
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _DlvdYTDDataEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _DlvdYTDDataEntityMetadata) : void
    {
        var oldValue : _DlvdYTDDataEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
    ...
    model_internal var _doValidationLastValOfBookedDateTime : String;
