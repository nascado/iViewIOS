...
function getFileView(file) {
    ...
    view.add(Ti.UI.createScrollableView({
        ...
        views: [
            Ti.UI.createImageView({ image: file.smallThumbnailURL, width: 'auto', height: 'auto' }),
            Ti.UI.createImageView({ image: file.largeThumbnailURL, width: 'auto', height: 'auto' }),
            Ti.UI.createImageView({ image: file.largerThumbnailURL, width: 'auto', height: 'auto' }),
            Ti.UI.createImageView({ image: file.previewThumbnailURL, width: 'auto', height: 'auto' })
        ]
    }));
